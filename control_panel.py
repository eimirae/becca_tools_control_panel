...
def figure():
    ...
    logo_filename = os.path.join('becca_utils_control_panel', 'images', 'logo_inline_light_blur.png')
...
def subfigure(fig, left=0.1, bottom=0.1, width=0.8, height=0.8):    
    #sub_filename = os.path.join('becca_utils_control_panel', 'images', 'tan_rectangle.png')
